...
public class Application {
            ...
            switch (command[0]) {
                ...
                default:
                    new Thread(() -> sender("The command entered is incorrect!\n" + "Example of valid command:\n" +
                            "remove_last\n" + "remove animalname\n" + "add {element}\n" + "show\n" + "info\n" + "logout\n" +
                            "add_if_max {element}\n" + "setSizeAndLocation name,size,location")).start();
            }
    ...
    private void setSizeAndLocation(String name, String size, String location){
        ...
        if (flag) {
            ...
            if (result == 0) {
                ...
                Animal anim = new Animal(name, siz, loc);
    ...
    private void show(){
        sender(Database.showAnimals().toString());
    }
    ...
    private void addIfMax(String element){
        ...
        try {
            ...
            if (animal != null && animal.getName() != null && animal.getSize() > 0 && animal.getLocation() > 0.0) {
