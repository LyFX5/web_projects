...
class DataBaseManager:
    def __init__(self):
        ...
        self.tables_creation_queries = {
                                    ...
                                    {UsersTableColumns.BOARDS.value} text,
                                    {UsersTableColumns.CHATS.value} text)''',
                                        self.boards_table_name: f'''CREATE TABLE {self.boards_table_name}
                                    ({BoardsTableColumns.NAME.value} text,
                                    {BoardsTableColumns.OWNER.value} text,
                                    {BoardsTableColumns.PUBLIC.value} text,
                                    {BoardsTableColumns.EDITABLE.value} text,
                                    {BoardsTableColumns.CONTENT.value} text)''',
                                        self.chats_table_name: f'''CREATE TABLE {self.chats_table_name}
                                    ({ChatsTableColumns.NAME.value} text,
                                    {ChatsTableColumns.CONTENT.value} text)'''
        }
